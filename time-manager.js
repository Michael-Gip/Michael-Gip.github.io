...
/* сделать удаление ключей из локал, при удалении соответствющих им подходов. понятьпринцип с помощью которого я сохраняю и удаляю уже сделанные элемменты. И подумать как это сделать для остальных. */
